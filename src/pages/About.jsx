    ...
    <div className="w-full px-4 sm:px-8 lg:px-16 xl:px-24 py-12">
      <div className="flex flex-col gap-14">
        <div className="text-center flex flex-col items-center gap-5">
          ...
          "
          >
            TaskOrbit is a modern productivity system designed for students who
            want to stay consistent, manage their time effectively, and turn
            daily efforts into long-term success.
          </p>
        </div>
        ...
        <div className="text-center flex flex-col items-center gap-4">
          ...
          "
          >
            Unlike traditional to-do apps, TaskOrbit focuses on consistency and
            habit-building. It helps you stay disciplined, visualize your
            growth, and improve daily without feeling overwhelmed.
          </p>
        </div>
